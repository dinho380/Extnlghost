...
function EnterGame.init()
  ...
  if clientVersion == 0 then clientVersion = 781 end
  ...
  EnterGame.setUniqueServer('ntoextnl.servegame.com', 7171, 781, 250, 350)
end
...
function EnterGame.setUniqueServer(host, port, protocol, windowWidth, windowHeight)
  ...
  if not windowWidth then windowWidth = 500 end
  enterGame:setWidth(windowWidth)
  if not windowHeight then windowHeight = 257 end
