...
function CharacterList.create(characters, account, otui)
  ...
  if account.premDays > 0 and account.premDays < 65535 then
    accountStatusLabel:setText(tr("VIP Account (%s) days left", account.premDays))
  elseif account.premDays >= 65535 then
    accountStatusLabel:setText(tr("Lifetime VIP Account"))
  else
...
function CharacterList.doLogin()
  ...
  if selected then
    ...
    displayErrorBox(tr('Error'), tr('Selecciona tu entrenador.'))
  end
end
