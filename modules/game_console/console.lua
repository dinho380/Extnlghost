SpeakTypesSettings = {
  none = {speakType = MessageModes.Spell, color = '#FE6500'},
  say = { speakType = MessageModes.Say, color = '#FFFF00' },
  whisper = { speakType = MessageModes.Whisper, color = '#FE6500', hideInConsole = false },
  yell = { speakType = MessageModes.Yell, color = '#FFFF00', hideInConsole = true},
...
SpeakTypes = {
  ...
  -- ignored types
  [MessageModes.Spell] = SpeakTypesSettings.monsterSay,
...
function addPrivateText(text, speaktype, name, isPrivateCommand, creatureName)
  ...
  elseif not focus then --not focus in privatetab
